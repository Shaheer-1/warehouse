 ...
 *
 * @property \App\Model\Table\CellsProductsTable $CellsProducts
 */
class CellsProductsController extends AppController
{
    ...
    {
        $cellsProduct = $this->CellsProducts->get($id, contain: ['Cells', 'Products']);
    ...
    public function add()
    {
        ...
        $cells = $this->CellsProducts->Cells->find('list', limit: 200)->all();
        $products = $this->CellsProducts->Products->find('list', limit: 200)->all();
        $this->set(compact('cellsProduct', 'cells', 'products'));
    }
